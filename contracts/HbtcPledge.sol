...
contract LPTokenWrapper {
    ...
    //HBTC
    IERC20 public y = IERC20(0x66a79D23E58475D2738179Ca52cd0b41d73f0BEa);
...
contract HBTCXcomRewards is LPTokenWrapper, IRewardDistributionRecipient {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function getReward() public updateReward(msg.sender) checkStart{
        ...
        if (reward > 0) {
            ...
            xcom.safeTransfer(msg.sender, reward);
